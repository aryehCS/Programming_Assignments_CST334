...
typedef struct Group {
    ...
    char* group_name; // todo: Pick an appropriate type for this! - done
    Person* group_members[GROUP_MAX_SIZE]; // todo: Pick an appropriate type for this! - done
    int num_members; // todo: Pick an appropriate type for this! - done
} Group;
