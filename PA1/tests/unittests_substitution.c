...
Test(SubstitutionCipher, is_reversible, .disabled=true) {
...
Test(SubstitutionCipher, decryption_key, .disabled=true) {
...
Test(SubstitutionCipher, encrypt_substitution, .disabled=true) {
  /*
...
Test(SubstitutionCipher, decrypt_substitution, .disabled=true) {
  /*
